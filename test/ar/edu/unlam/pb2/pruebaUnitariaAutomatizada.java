...
//A
	...
	public void queSePuedaDarDeAltaUnaCasaEnLaInmobiliaria() {
		Casa casita1 = new Casa("ardoino", 123, null, "ramos", 500000.5, true, TipoDeOperacion.ALQUILER, propietario1, "C0");
...
//B
	...
	public void queSePuedaDarDeAltaDosCasaEnLaInmobiliaria() {	
		Casa casita1 = new Casa("ardoino", 123, null, "ramos", 50000.5, true, TipoDeOperacion.ALQUILER, propietario1, "C0");
		Casa casita2 = new Casa("monteagudo", 254, null, "temos", 120000.5, true, TipoDeOperacion.VENTA, propietario1, "C1");
...
//E
	...
	public void queSePuedaObtenerElValorPromedioDeLasCasas() {
		Casa casita1 = new Casa("ardoino", 123, null, "ramos", 100000.0, true, TipoDeOperacion.ALQUILER, propietario1, "C0");
		Casa casita2 = new Casa("monteagudo", 254, null, "temos", 200000.0, true, TipoDeOperacion.VENTA, propietario1, "C1");
...
//F
	...
	public void queSePuedaTraerCasasPorPrecioOrdenado() {
		Casa casita1 = new Casa("ardoino", 123, null, "ramos", 150000.5, true, TipoDeOperacion.ALQUILER, propietario1, "C0");
		Casa casita2 = new Casa("monteagudo", 254, null, "temos", 120000.5, true, TipoDeOperacion.VENTA, propietario1, "C1");
	...
	public void queSePuedaTraerCasasPorUbicacionOrdenado() {
		Casa casita1 = new Casa("ardoino", 123, null, "tramos", 150000.5, true, TipoDeOperacion.ALQUILER, propietario1, "C0");
		Casa casita2 = new Casa("monteagudo", 254, null, "temos", 120000.5, true, TipoDeOperacion.VENTA, propietario1, "C1");
	...
	public void queSePuedaRealizarUnaPermuta() {
		...
		Casa casita1 = new Casa("ardoino", 123, null, "ramos", 50000.5, true, TipoDeOperacion.PERMUTA, propietario1, "C1");
...
//I
	...
	public void queSePuedaRealizarLaVentaDeUnaPropiedad() {
		Casa casita1 = new Casa("ardoino", 123, null, "ramos", 50000.5, true, TipoDeOperacion.VENTA, propietario1, "C0");
...
//J	
	...
	public void queSePuedaRealizarElAlquilerDeUnaPropiedad() {
		Casa casita1 = new Casa("ardoino", 123, null, "ramos", 5.5, true, TipoDeOperacion.ALQUILER, propietario1, "C0");
...
//K	
	...
	public void queSePuedaRealizarLaPermutaDeDosPropiedades() {
		...
		Casa casita1 = new Casa("ardoino", 123, null, "ramos", 5.5, true, TipoDeOperacion.PERMUTA, propietario1, "C1");
...
//L	
	...
	public void queSePuedaRealizarLaBusquedaDeCasasPorRangoDePreciosYElResultadoEsteOrdenadoPorPrecio() {
		Casa casita1 = new Casa("ardoino", 123, null, "ramos", 70000.5, true, TipoDeOperacion.VENTA, propietario1, "C0");
		Casa casita2 = new Casa("monteagudo", 254, null, "temos", 120000.5, true, TipoDeOperacion.VENTA, propietario1, "C1");
		Casa casita3 = new Casa("ardoino", 123, null, "ramos", 50000.5, true, TipoDeOperacion.VENTA, propietario1, "C2");
		Casa casita4 = new Casa("monteagudo", 254, null, "temos", 140000.5, true, TipoDeOperacion.VENTA, propietario1, "C3");
...
//M
	...
	public void queSePuedaRealizarLaBusquedaDeCasasPorUbicacionYElResultadoEsteOrdenadoPorUbicacion() {
		Casa casita1 = new Casa("florida", 223, null, "ramos", 70000.5, true, TipoDeOperacion.VENTA, propietario1, "C0");
		Casa casita2 = new Casa("monteagudo", 254, null, "ramos", 120000.5, true, TipoDeOperacion.VENTA, propietario1, "C1");
		Casa casita3 = new Casa("ardoino", 123, null, "ramos", 50000.5, true, TipoDeOperacion.VENTA, propietario1, "C2");
		Casa casita4 = new Casa("suipacha", 254, null, "ramos", 140000.5, true, TipoDeOperacion.VENTA, propietario1, "C3");
...
//P
	...
	public void queAlBuscarPorUnCriterioQueNoArrojeResultadosSeProduzcaLaExcepcionSinResultadosException(){
		Casa casita1 = new Casa("ardoino", 123, null, "ramos", 50000.5, true, TipoDeOperacion.ALQUILER, propietario1, "C1");
		Ph  ph1 = new Ph("lagos", 123, "1", "ramos", 50000.5, true, TipoDeOperacion.ALQUILER, propietario1, "P1");
...
//Q
	...
	public void queAlIntentarGuardarUnaPropiedadParaLaVentaCuyoImporteEstaPorDebajoDelUmbral10000SeArrojeLaExcepcionUmbralMinimoNoAlcanzadoException(){
		Casa casita1 = new Casa("ardoino", 123, null, "ramos", 500.5, true, TipoDeOperacion.VENTA, propietario1, "C1");
